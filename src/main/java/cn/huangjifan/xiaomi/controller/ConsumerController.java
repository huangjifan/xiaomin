...
import cn.huangjifan.xiaomi.service.ConsumerService;
...
public class ConsumerController {
    ...
    @ResponseBody   //序列化-->类型转化-->jackson-->json
    public ResponseMessage login(@RequestParam String username,
        ...
        /*
                ...
                2.登记用户  --会话跟踪[session]
         */
        System.out.println("接受到的请求：/consumer/login/auth");
    ...
    public ResponseMessage register(@RequestParam String username,
        ...
        return ResponseMessage.error().addObject("mag",result);
    }
